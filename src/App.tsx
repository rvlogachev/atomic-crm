...
const App = () => (
    <CRM 
        title='SM CRM'
        companySectors={['Металлургия', 'Производство', 'Инжиниринг и безопасность', 'Нефтегаз и химия', 'Логистика и транспорт', 'Склады и e-commerce', 'Ритейл и FMCG', 'Аэропорты', 'Финансы и страхование', 'Стройка', 'IT и телекоммуникации', 'Образование', 'Медицина', 'Культура', 'Госсектор', 'Другое']}
