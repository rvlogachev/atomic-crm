...
const App = () => (
    <CRM 
        ...
        dealCategories={['Модель Anylogic', 'Модель Anylogistix', 'Пилот / PoC', 'Цифровой двойник (платформа)', 'Оптимизационный модуль', 'AI-ассистент / чат-бот', 'Дашборды', 'Обучение и тренинги', 'Консалтинг', 'Лицензии и ПО партнёров','Другое']}
