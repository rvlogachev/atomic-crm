...
const App = () => (
    <CRM 
        title='SM CRM'
        companySectors={['Металлургия', 'Производство', 'Нефтегаз и химия', 'Логистика и транспорт', 'Склады и e-commerce', 'Ритейл и FMCG', 'Финансы и страхование', 'Стройка', 'IT и телекоммуникации', 'Образование', 'Медицина', 'Культура', 'Госсектор', 'Другое']}
