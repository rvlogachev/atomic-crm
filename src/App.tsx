...
const App = () => (
    <CRM 
        title='SM CRM'
        companySectors={['Металлургия', 'Производство', 'Инжиниринг и безопасность', 'Нефтегаз и химия', 'Логистика и транспорт', 'Добыча и переработка', 'Склады и e-commerce', 'Ритейл и FMCG', 'Аэропорты', 'Финансы и страхование', 'Стройка', 'IT и телекоммуникации', 'Образование', 'Медицина', 'Культура', 'Госсектор', 'Другое']}
        dealCategories={['Модель Anylogic', 'Модель Anylogistix', 'Tibbo Aggregate', 'Пилот / PoC', 'Цифровой двойник (платформа)', 'Оптимизационный модуль', 'AI-ассистент / чат-бот', 'Дашборды', 'Обучение и тренинги', 'Консалтинг', 'Лицензии и ПО партнёров','Другое']}
